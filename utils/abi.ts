export const bridgeContractAbi = [
  ...
  { inputs: [], name: "AlreadyBridged", type: "error" },
  { inputs: [], name: "ArrayLengthMismatch", type: "error" },
  { inputs: [], name: "BlobRootEmpty", type: "error" },
  { inputs: [], name: "BridgeRootEmpty", type: "error" },
  { inputs: [], name: "DataRootCommitmentEmpty", type: "error" },
  { inputs: [], name: "EnforcedPause", type: "error" },
  { inputs: [], name: "ExpectedPause", type: "error" },
  { inputs: [], name: "FailedInnerCall", type: "error" },
  { inputs: [], name: "FeeTooLow", type: "error" },
  { inputs: [], name: "InvalidAssetId", type: "error" },
  { inputs: [], name: "InvalidDataLength", type: "error" },
  { inputs: [], name: "InvalidDataRootProof", type: "error" },
  { inputs: [], name: "InvalidDestinationOrAmount", type: "error" },
  { inputs: [], name: "InvalidDomain", type: "error" },
  { inputs: [], name: "InvalidFungibleTokenTransfer", type: "error" },
  { inputs: [], name: "InvalidInitialization", type: "error" },
  { inputs: [], name: "InvalidLeaf", type: "error" },
  ...
  { inputs: [], name: "UnlockFailed", type: "error" },
  ...
  },
  {
    inputs: [],
    name: "avail",
    outputs: [{ internalType: "contract IAvail", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  {
    inputs: [
      { internalType: "uint256", name: "newFeePerByte", type: "uint256" },
      { internalType: "address", name: "newFeeRecipient", type: "address" },
      { internalType: "contract IAvail", name: "newAvail", type: "address" },
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "uint64", name: "messageId", type: "uint64" },
        ],
      ...
      },
      {
        components: [
          ...
          { internalType: "bytes32", name: "rangeHash", type: "bytes32" },
          { internalType: "uint256", name: "dataRootIndex", type: "uint256" },
          { internalType: "bytes32", name: "blobRoot", type: "bytes32" },
          { internalType: "bytes32", name: "bridgeRoot", type: "bytes32" },
  ...
  {
    inputs: [{ internalType: "bytes32", name: "recipient", type: "bytes32" }],
    name: "sendETH",
    outputs: [],
  ...
  },
  {
    inputs: [],
    name: "vectorx",
    outputs: [{ internalType: "contract IVectorx", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
